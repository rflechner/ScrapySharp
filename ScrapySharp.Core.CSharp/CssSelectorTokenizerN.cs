...
namespace StartupCode.ScrapySharp.Core.CSharp
{
    internal class CssSelectorTokenizerN
    {
        ...
        {
            return new CssSelectorTokenizerN.TokenStr501(s);
        }
        internal static FSharpList<Token> tokenize60(CssSelectorTokenizer x, FSharpList<Token> acc, FSharpList<char> sourceChars)
        {
            ...
            for (; ; )
            {
                            ...
                            if (fsharpList2.TailOrNull.TailOrNull != null)
                            {
                                ...
                                switch (t.HeadOrDefault)
                                {
                                    case '=':
                                        {
                                            t2 = t.TailOrNull;
                                            tuple = CssSelectorTokenizerN.readString26(x, "", t2);
                                    ...
                                    default:
                                        {
                                            FSharpOption<FSharpList<char>> fsharpOption = CssSelectorTokenizerN.TokenStr49(":checkbox").Invoke(sourceChars);
                        ...
                        default:
                            switch (fsharpList2.HeadOrDefault)
                            {
                                case '#':
                                    {
                                        t = fsharpList2.TailOrNull;
                                        tuple = CssSelectorTokenizerN.readString26(x, "", t);
                                        t2 = tuple.Item2;
                                        string s = tuple.Item1;
                ...
                continue;
            IL_235:
                FSharpOption<FSharpList<char>> fsharpOption2 = CssSelectorTokenizerN.TokenStr49(":selected").Invoke(sourceChars);
                ...
                {
                    FSharpOption<FSharpList<char>> fsharpOption3 = CssSelectorTokenizerN.TokenStr49(":checked").Invoke(sourceChars);
                    ...
                    {
                        FSharpOption<FSharpList<char>> fsharpOption4 = CssSelectorTokenizerN.TokenStr49(":disabled").Invoke(sourceChars);
                        ...
                        {
                            FSharpOption<FSharpList<char>> fsharpOption5 = CssSelectorTokenizerN.TokenStr49(":enabled").Invoke(sourceChars);
                                            ...
                                            default:
                                                {
                                                    ...
                                                    tuple = CssSelectorTokenizerN.readString26(x, s, t2);
                                                    FSharpList<char> fsharpList7 = tuple.Item2;
        ...
        IL_440:
            ...
            if (!char.IsLetterOrDigit(c))
            {
                ...
                string s = FSharpFunc<char, int>.InvokeFast<string>(new CssSelectorTokenizerN.tokenize1411(clo), c, offset);
        ...
        internal sealed class TokenStr501 : FSharpFunc<FSharpList<char>, FSharpOption<FSharpList<char>>>
        {
            ...
            public override FSharpOption<FSharpList<char>> Invoke(FSharpList<char> x)
            {
                ...
                return CssSelectorTokenizerN.equal52<char>(x, chars);
            }
            public string s;
        }
        ...
        internal sealed class tokenize1411 : FSharpFunc<char, FSharpFunc<int, string>>
        {
            ...
            public override FSharpFunc<int, string> Invoke(char arg10)
            {
                ...
                return new CssSelectorTokenizerN.tokenize1412(clo);
            }
